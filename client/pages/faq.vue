  ...
  <div>
    <div class="header bg-gradient-info py-7 py-lg-8 pt-lg-9">
      <b-container class="pt--8">
        ...
        >
          <template #header
            ><div class="text-white">Have Any Questions?</div></template
          >
          <b-form
        ...
        <b-col md="5" lg="3" class="pt-3 pt-sm-3">
          <b-card>
            ...
            <ul class="mt-4">
              ...
              >
                <div
                  class="rounded-circle mr-2 mt-1"
                  :class="'bg-' + category.color"
                  :style="{ height: '15px', width: '15px' }"
                ></div>
                <h4 class="cursor-pointer align-self-center">
                  {{ category.name }}
                </h4>
              </div>
            </ul>
    ...
    return {
      ...
      faqs: [
        ...
        },
        {
          ...
          ans: "You can find the source code on <a href='https://github.com/JarivdKaap/IsThisMapSafe' rel='noopener' target='_blank'>github</a>.",
        },
        {
          id: 5,
          categoryId: 2,
          question: 'Can I run this analyzer on my own computer?',
          ans: "Yes, you can find this on Blakintosh's <a href='https://github.com/Blakintosh/FastScanner' rel='noopener' target='_blank'>github</a>.",
        },
        {
          id: 6,
          categoryId: 2,
      ...
      return this.faqs.filter((faq) => {
        if (this.faqFilter == 1)
          return (
            ...
            faq.ans.toLowerCase().includes(this.search.toLowerCase())
          )
        return (
          faq.categoryId == this.faqFilter &&
          (faq.question.toLowerCase().includes(this.search.toLowerCase()) ||
            faq.ans.toLowerCase().includes(this.search.toLowerCase()))
        )
      })
